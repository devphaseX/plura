...
export type TeamData = GetUserWithAgencyAssetsReturnType;

export const searchableColumns: DataTableSearchableColumn<TeamData>[] = [];
...
export const columns: ColumnDef<TeamData>[] = [
...

  {
    ...
    cell: ({ row }) => {
      ...
      const ownedAccounts = row.original?.permissions;
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge
          className={clsx({
            'bg-emerald-500': role === 'agency-owner',
            'bg-orange-400': role === 'agency-admin',
            'bg-primary': role === 'subaccount-user',
            'bg-muted': role === 'subaccount-guest',
          })}
        >
          {role}
        </Badge>
            ...
            onClick={() => {
              setOpen(
                ...
                >
                  <UserDetails
                    type="agency"
                    id={rowData.agency?.id as string}
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter className="flex items-center">
          ...
          <AlertDialogAction
            ...
            onClick={async () => {
              setLoading(true);
              await removeUserFromAgency(rowData.userId);
              toast({
                title: 'Deleted User',
                description:
